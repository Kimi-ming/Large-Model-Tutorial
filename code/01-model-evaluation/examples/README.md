...
| **InternVL** 🆕 | `internvl_inference.py` | GPT-4V级别性能、多语言、高分辨率 | 中英双语 |
...
# InternVL高性能推理
python internvl_inference.py --image path/to/image.jpg --demo all
```
...
```bash
# 基础推理
python internvl_inference.py --image image.jpg
...
# 特定任务
python internvl_inference.py --image image.jpg --demo vqa
```

### 性能对比

| 任务 | CLIP | BLIP-2 | LLaVA | Qwen-VL | InternVL |
|------|------|--------|-------|---------|----------|
| **中文VQA** | ❌ | ⭐ | ⭐⭐ | ⭐⭐⭐⭐⭐ | ⭐⭐⭐⭐⭐ |
| **英文VQA** | ⭐⭐ | ⭐⭐⭐⭐ | ⭐⭐⭐⭐⭐ | ⭐⭐⭐⭐ | ⭐⭐⭐⭐⭐ |
| **OCR识别** | ❌ | ⭐⭐ | ⭐⭐⭐ | ⭐⭐⭐⭐⭐ | ⭐⭐⭐⭐⭐ |
...
- [Qwen-VL模型详解](../../../docs/01-模型调研与选型/07-Qwen-VL模型详解.md) ✨
