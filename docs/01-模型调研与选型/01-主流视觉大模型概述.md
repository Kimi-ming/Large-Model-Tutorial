...
**开发者**：Salesforce Research (2022/2023) | [GitHub](https://github.com/salesforce/BLIP) | [HuggingFace](https://huggingface.co/Salesforce/blip2-opt-2.7b)
...
**开发者**：UW Madison & Microsoft (2023) | [GitHub](https://github.com/haotian-liu/LLaVA) | [HuggingFace](https://huggingface.co/liuhaotian/llava-v1.5-7b)
...
**开发者**：上海AI Lab (2023) | [GitHub](https://github.com/OpenGVLab/InternVL) | [HuggingFace](https://huggingface.co/OpenGVLab/InternVL-Chat-V1-5)
...
**开发者**：智谱AI (2023) | [GitHub](https://github.com/THUDM/CogVLM) | [HuggingFace](https://huggingface.co/THUDM/cogvlm-chat-hf)
...
**开发者**：OpenAI (2023) | [官方文档](https://platform.openai.com/docs/guides/vision)
...
**开发者**：Google (2023) | [官方文档](https://deepmind.google/technologies/gemini/)
...
**服务器（NVIDIA）** → 任意模型  
**服务器（华为昇腾）** → 需验证兼容性（推荐CLIP、SAM等主流模型）  
**云API** → GPT-4V, Gemini
